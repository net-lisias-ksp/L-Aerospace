...
namespace L_Aerospace
{
	public static class Log
	{
		...
		public static void err(Exception e, object offended)
		{
			log.error(offended, e);
		}

		public static void err(string msg, params object[] @params)
		{
			log.error(msg, @params);
		}

		public static void err(Exception e, string msg, params object[] @params)
		{
